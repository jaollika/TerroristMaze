...
public class Peli {
    ...
    public boolean tarkistaSijainninLaillisuus(int dX, int dY, int[][] ruudukko) {
...
//        } 
    ...
    public void luoYksiRajahdysSuunta(int dx, int dy, int x, int y, int voima, int[][] ruudukko){
        while(voima > 0){
            x = x+dx;
            y = y+dy;
            if(ruudukko[x][y] != 1){
